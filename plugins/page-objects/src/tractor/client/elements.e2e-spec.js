/*{"name":"Elements","tests":[{"name":"add Element"},{"name":"add Element group"},{"name":"add typed Element"},{"name":"add typed Element group"},{"name":"Invalid name - required"},{"name":"Invalid name - valid identifier"},{"name":"Invalid name - unique"},{"name":"Invalid selector - required"}],"version":"1.4.0"}*/
