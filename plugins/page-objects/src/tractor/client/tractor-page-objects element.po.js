/*{"name":"tractor-page-objects element","elements":[{"name":"name input"},{"name":"name validation"},{"name":"remove element button"},{"name":"selector input"},{"name":"selector validation"},{"name":"group checkbox"},{"name":"add type button"},{"name":"type autocomplete","type":"tractor-autocomplete"}],"actions":[{"name":"add element","parameters":[{"name":"name"},{"name":"selector"}]},{"name":"add type","parameters":[{"name":"type"}]},{"name":"toggle group","parameters":[]},{"name":"get name","parameters":[]},{"name":"get name validation","parameters":[]},{"name":"get selector","parameters":[]},{"name":"get selector validation","parameters":[]},{"name":"get group","parameters":[]},{"name":"get type","parameters":[]}],"version":"0.7.0"}*/
module.exports = function () {
    var TractorAutocomplete = require('../../../../../node_modules/@tractor/ui/dist/page-objects/Core/Components/Autocomplete/tractor-autocomplete.po.js');
