/*{"name":"tractor-page-objects action","elements":[{"name":"name input"},{"name":"name validation"},{"name":"remove action button"},{"name":"add parameter button"},{"name":"parameters","type":"tractor-page-objects action parameter","group":true},{"name":"add interaction button"},{"name":"interactions","type":"tractor-page-objects action interaction","group":true}],"actions":[{"name":"add action","parameters":[{"name":"name"}]},{"name":"add parameter","parameters":[{"name":"name"}]},{"name":"add interaction","parameters":[{"name":"element"},{"name":"action"}]},{"name":"add argument","parameters":[{"name":"name"},{"name":"value"}]},{"name":"get name","parameters":[]},{"name":"get name validation","parameters":[]}],"version":"1.7.0"}*/
