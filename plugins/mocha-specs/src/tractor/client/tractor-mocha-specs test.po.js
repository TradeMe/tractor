/*{"name":"tractor-mocha-specs test","elements":[{"name":"name input"},{"name":"name validation"},{"name":"remove test button"},{"name":"only checkbox"},{"name":"skip checkbox"},{"name":"skip reason input"},{"name":"add interaction button"},{"name":"add assertion button"},{"name":"interactions","type":"tractor-mocha-specs interaction","group":true},{"name":"assertions","type":"tractor-mocha-specs assertion","group":true}],"actions":[{"name":"add test","parameters":[{"name":"name"}]},{"name":"toggle only","parameters":[]},{"name":"get only","parameters":[]},{"name":"toggle skip","parameters":[]},{"name":"get skip","parameters":[]},{"name":"set skip reason","parameters":[{"name":"skip reason"}]},{"name":"get skip reason","parameters":[]},{"name":"get name","parameters":[]},{"name":"get name validation","parameters":[]}],"version":"1.7.0"}*/
