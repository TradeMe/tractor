...
//             directories: [],
//             files: [],
//             path: path.join(path.sep, 'file-structure', 'directory', 'oldName')
//         };
//         let parentDirectory = {
//             addDirectory: _.noop,
//             extension: '.js',
...
//                 oldName: 'oldName',
//                 newName: 'newName',
//                 directoryPath: path.join(path.sep, 'file-structure', 'directory')
//             },
//             params: {}
//         };
//         let response = {
...
//             expect(newDirectory.path).to.equal(path.join(path.sep, 'file-structure', 'directory', 'newName'));
//
//         })
//         .finally(() => {
...
//             path: path.join(path.sep, 'file-structure', 'directory', 'newName')
//         };
//         let parentDirectory = {
//             addDirectory: _.noop,
//             extension: '.js',
...
//             expect(newDirectory.path).to.equal(path.join(path.sep, 'file-structure', 'directory', 'newName (1)'));
//         })
//         .finally(() => {
//             Directory.prototype.save.restore();
//             fileStructure.getStructure.restore();
...
//             directories: [],
//             files: [],
//             path: path.join(path.sep, 'file-structure', 'directory', 'oldName', 'subDirectory')
//         };
//         let directory = {
//             delete: _.noop,
...
//             expect(newSubdirectory.path).to.equal(path.join(path.sep, 'file-structure', 'directory', 'newName', 'subDirectory'));
//
//             expect(Directory.prototype.save).to.have.been.called();
...
//             path: path.join(path.sep, 'file-structure', 'directory', 'oldName'),
//             fileStructure: {
//                 rootDir: path.join(path.sep, 'file-structure')
//             }
//         };
//         let file = new File(path.join(path.sep, 'file-structure', 'directory', 'oldName', 'file'), directory);
//         let parentDirectory = {
//             addDirectory: _.noop,
//             extension: '.js',
//             path: path.join(path.sep, 'file-structure', 'directory')
...
//             expect(newFile.path).to.equal(path.join(path.sep, 'file-structure', 'directory', 'newName', 'file'));
//         })
//         .finally(() => {
//             Directory.prototype.save.restore();
//             fileStructure.getStructure.restore();
...
//         return editItemPath.handler(request, response)
//         .then(() => {
//             expect(tractorErrorHandler.handle).to.have.been.calledWith(response, new TractorError('Unknown operation', CONSTANTS.SERVER_ERROR));
//         })
//         .finally(() => {
