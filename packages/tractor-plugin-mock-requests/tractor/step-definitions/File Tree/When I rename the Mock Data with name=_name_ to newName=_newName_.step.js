/*{"name":"When I rename the Mock Data with name=\"name\" to newName=\"newName\"","pageObjects":[{"name":"tractor-file-tree"}],"mockRequests":[]}*/
module.exports = function () {
    ...
    this.When(/^I rename the Mock Data with name="([^"]*)" to newName="([^"]*)"$/, function (name, newName, done) {
