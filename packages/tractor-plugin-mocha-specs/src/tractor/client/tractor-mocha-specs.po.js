/*{"name":"tractor-mocha-specs","elements":[{"name":"name"},{"name":"name input"},{"name":"name validation"},{"name":"save button"},{"name":"confirm save dialog"},{"name":"new file button"},{"name":"add test button"},{"name":"tests","type":"tractor-mocha-specs test"}],"actions":[{"name":"create and save mocha spec","parameters":[{"name":"name"}]},{"name":"save mocha spec","parameters":[]},{"name":"get name","parameters":[]},{"name":"get name validation","parameters":[]},{"name":"add test","parameters":[{"name":"name"}]}],"version":"0.5.2"}*/
module.exports = function () {
    ...
    var TractorMochaSpecs = function TractorMochaSpecs(parent) {
