/*{"name":"tractor-file-tree","elements":[{"name":"page object file","type":"tractor-file-tree item","group":true}],"actions":[{"name":"open file","parameters":[{"name":"selector"}]},{"name":"edit file name","parameters":[{"name":"selector"},{"name":"new name"}]},{"name":"get file name","parameters":[{"name":"selector"}]},{"name":"get file status text","parameters":[{"name":"selector"}]}],"version":"0.7.0"}*/
