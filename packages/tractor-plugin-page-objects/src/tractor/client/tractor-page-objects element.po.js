/*{"name":"tractor-page-objects element","elements":[{"name":"name input"},{"name":"name validation"},{"name":"remove element button"},{"name":"selector input"},{"name":"selector validation"},{"name":"is group checkbox"},{"name":"add type button"},{"name":"type select"}],"actions":[{"name":"add element","parameters":[{"name":"name"},{"name":"selector"}]},{"name":"add type","parameters":[{"name":"type"}]},{"name":"toggle is group","parameters":[]},{"name":"get name","parameters":[]},{"name":"get name validation","parameters":[]},{"name":"get selector","parameters":[]},{"name":"get selector validation","parameters":[]},{"name":"get is group","parameters":[]},{"name":"get type","parameters":[]}],"version":"0.5.0"}*/
