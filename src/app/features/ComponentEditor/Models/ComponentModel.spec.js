...
describe('ComponentModel.js:', function () {
    ...
    beforeEach(function () {
        ...
        angular.mock.inject(function (_ComponentModel_, _BrowserModel_, _ElementModel_, _FilterModel_, _ActionModel_, _InteractionModel_) {
    ...
    describe('ComponentModel.browser:', function () {
        it('should return the first element, which is always the `browser`:', function () {
            var componentModel = new ComponentModel();
