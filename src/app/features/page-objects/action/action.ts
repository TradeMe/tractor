...
import { Interaction, InteractionFactory } from '../interaction/interaction';
...
export class ActionFactory implements Factory<Action> {
    ...
    public create (pageObject: PageObject): Action {
        let instance = new Action(this.astService, this.interactionFactory, this.parameterFactory);
        instance.init(pageObject);
        return instance;
    }
}
...
export class Action {
    ...
    public init (pageObject: PageObject) {
