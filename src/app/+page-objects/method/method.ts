...
// Dependencies:
import { Argument, ArgumentFactory, ARGUMENT_PROVIDERS } from '../argument/argument';
...
export class MethodFactory implements Factory<Method> {
    ...
    create (interaction: Interaction, method) {
        let instance = new Method(interaction, method);
        instance.setServices(this.argumentFactory);
        return instance;
    }
}
...
export class Method {
    ...
    constructor (interaction: Interaction, method) {
    ...
    public setServices (argumentFactory: ArgumentFactory) {
