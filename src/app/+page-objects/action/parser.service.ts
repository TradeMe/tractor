...
// Dependencies:
import { Action, ActionFactory, ACTION_PROVIDERS } from './action';
import { ASTService, AST_PROVIDERS } from '../../shared/ast/ast.service';
import { InteractionParserService, INTERACTION_PARSER_PROVIDERS } from '../interaction/parser.service';
import { PageObject } from '../page-object/page-object';
import { ParameterParserService, PARAMETER_PARSER_PROVIDERS } from '../parameter/parser.service';
...
export const ACTION_PARSER_PROVIDERS = [
    ActionParserService,
    ACTION_PROVIDERS,
    AST_PROVIDERS,
    INTERACTION_PARSER_PROVIDERS,
    PARAMETER_PARSER_PROVIDERS
];
