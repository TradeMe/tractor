...
export class ArgumentFactory implements Factory<Argument> {
    ...
    public create (method: Method, argument): Argument {
        let instance = new Argument(method, argument);
...
export class Argument {
    ...
    constructor (method: Method, argument) {
        this._argument = argument;
        this._method = method;
    }

    public setServices (astService: ASTService, stringToLiteralService: StringToLiteralService): void {
...
export const ARGUMENT_PROVIDERS = [
    ArgumentFactory,
    AST_PROVIDERS,
